...
class Location {
  ...
  static Map<int, Location> _locations = {
    1: Location(1, 'London', 'assets/images/london.jpeg', [
      LocationFact("Metropol",
          "London is the capital and largest city of England and the United Kingdom.[8][9] The city stands on the River Thames in the south-east of England, at the head of its 50-mile (80 km) estuary leading to the North Sea, London has been a major settlement for two millennia."),
      LocationFact("Global City",
    ...
    2: Location(2, 'Istanbul', 'assets/images/istanbul.jpeg', [
      LocationFact("Populous",
      ...
      LocationFact("Tourist Destination",
  ...
  static Iterable<Location> fetchAll() {
    return Location._locations.values;
  }

  static Location findById(int id) {
    return _locations.containsKey(id) ? _locations[id] : null;
  }
}
